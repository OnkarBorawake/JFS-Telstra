...
public class Main {
	...
	public static void main(String[] args) {
		...
		emparr[1] = new Manager(202,"xyz",75000,"RD",15);
		emparr[2] = new Manager(203,"xyzq",65000,"HRD",15);
		emparr[3] = new Programmer(300,"abcdefg",1660000,5,"Java");
		System.out.println("Printing employee details");
		
		for(Employee emp1 : emparr)
		{
			System.out.println(emp1.getDetails());
			//System.out.println(emp1.calcNetSal(0, 0));
		}
	}
